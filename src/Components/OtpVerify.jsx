...
//     emailjs
//       .send(
//         'service_tm7jqfo', // Replace with your service ID
//         'template_f3jw6gn', // Replace with your template ID
//         {
//           to_email: email,
//           otp: otp,
//         },
//         'SWDBq1p1xbS0M1r-r' // Replace with your public key
//       )
//       .then(
//         (response) => {
...
//   useEffect(() => {
//     if (email  && otp && !otpSentRef.current) {
//       sendOtpEmail();
//     }
//   }, [email, otp]);
